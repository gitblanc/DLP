...
public class Lexicon extends Lexer {
	...
	public static final int
		LITENT=1, LITREAL=2, MAS=3, MENOS=4, IGUAL=5, PCOMA=6, READ=7, PRINT=8, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LITENT", "LITREAL", "MAS", "MENOS", "IGUAL", "PCOMA", "READ", "PRINT", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "LITENT", "LITREAL", "MAS", "MENOS", "IGUAL", "PCOMA", "READ", 
			"PRINT", "INT", "FLOAT", "IDENT", "LINE_COMMENT", "MULTILINE_COMMENT", 
			"WHITESPACE"
		};
	}
	...
	public static final String _serializedATN =
		...
		"9\7g\2\29:\7c\2\2:;\7f\2\2;\20\3\2\2\2<=\7r\2\2=>\7t\2\2>?\7k\2\2?@\7"+
		"p\2\2@A\7v\2\2A\22\3\2\2\2BC\7k\2\2CD\7p\2\2DE\7v\2\2E\24\3\2\2\2FG\7"+
